...
WhiteCatFilter::WhiteCatFilter() : Program(COMMON_VERTEX_SHADER,"filter/whitecat.glsl") {}

int WhiteCatFilter::initTexture() {
    ...
    mToneCurveTexture=OpenglUtils::loadTexture(arrayOfByte,256,2);
    delete []arrayOfByte;
...
void WhiteCatFilter::initLocation() {
...
WhiteCatFilter::WhiteCatFilter(const char *vertexPath, const char *fragPath) : Program(vertexPath,
                                                                                       fragPath) {}
